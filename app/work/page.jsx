...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab animi aut doloremque eligendi expedita fuga laboriosam.",
...
const WorkPage = () => {
  ...
  const handleSlideChange = (swiper) => {
    ...
    setProject(projects.at(currentSlideIndex));
  };
              ...
              {projects.map((project, index) => (
                <SwiperSlide key={index}>
                  ...
                  >
                    ...
                    <div
                      className={
                        "absolute top-0 bottom-0 w-full h-full bg-black/10 z-10"
                      }
                    ></div>
